...
starthere/replace_project_meta: APP_SLUG ?= $(shell read -p "App Slug: " app_name; echo $$app_name)
starthere/replace_project_meta: APP_NAME ?= $(shell read -p "App Name (Human-Readable): " app_name_readable; echo $$app_name_readable)
starthere/replace_project_meta:
...
.PHONY: starthere/replace_project_meta

starthere/git_reinit:
	rm -rf .git
	git init
.PHONY: starthere/git_reinit

starthere: starthere/git_reinit starthere/replace_project_meta
.PHONY: starthere
# <<REMOVE_END>>
